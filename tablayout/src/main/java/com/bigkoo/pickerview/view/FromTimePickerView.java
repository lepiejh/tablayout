...
public class FromTimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            TextView tv_year_all = (TextView) findViewById(R.id.tv_year_all);
            TextView tv_month_all = (TextView) findViewById(R.id.tv_month_all);
            TextView tv_day_all = (TextView) findViewById(R.id.tv_day_all);
            TextView tv_hour_all = (TextView) findViewById(R.id.tv_hour_all);
            TextView tv_min_all = (TextView) findViewById(R.id.tv_min_all);
            tv_year.setVisibility(mPickerOptions.isShowYearMonth ? View.VISIBLE : View.GONE);
            tv_month.setVisibility(mPickerOptions.isShowYearMonth ? View.VISIBLE : View.GONE);
            tv_year_all.setVisibility(mPickerOptions.isShowYMD ? View.VISIBLE : View.GONE);
            tv_month_all.setVisibility(mPickerOptions.isShowYMD ? View.VISIBLE : View.GONE);
            tv_day_all.setVisibility(mPickerOptions.isShowYMD ? View.VISIBLE : View.GONE);
            tv_hour_all.setVisibility(mPickerOptions.isShowYMD ? View.VISIBLE : View.GONE);
            tv_min_all.setVisibility(mPickerOptions.isShowYMD ? View.VISIBLE : View.GONE);
        ...
        // 时间转轮 自定义控件
        ConstraintLayout timePickerView = (ConstraintLayout) findViewById(R.id.timepicker);
        timePickerView.setBackgroundColor(mPickerOptions.bgColorWheel);

        initWheelTime(timePickerView);
    }

    private void initWheelTime(ConstraintLayout timePickerView) {
        wheelTime = new WheelTime(timePickerView, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent,mPickerOptions.arrayMin,mPickerOptions.isShowYMD);
