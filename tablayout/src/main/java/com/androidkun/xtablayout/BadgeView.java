...
public class BadgeView extends AppCompatTextView {
    ...
    private void init(Context context, View target, int tabIndex) {
        ...
        badgeMarginH = DpiUtils.dip2px(Utils.getContext(),DEFAULT_MARGIN_DIP);
    ...
    protected void applyLayoutParams() {
        ...
        if (!android.text.TextUtils.isEmpty(getText())) {
            int size = DpiUtils.dip2px(Utils.getContext(),14);
            lp.height = size;
            lp.width = size;
        }
    ...
    public void setBadgeMarginDip(int horizontal, int vertical) {
        this.badgeMarginH = DpiUtils.dip2px(Utils.getContext(),horizontal);
        this.badgeMarginV = DpiUtils.dip2px(Utils.getContext(),vertical);
    }
    ...
    public void setOvalShape(int radius) {
        LayoutParams params = this.getLayoutParams();
        params.height = DpiUtils.dip2px(Utils.getContext(),radius * 2);
        params.width = DpiUtils.dip2px(Utils.getContext(),radius * 2);
        setBackgroundResource(R.drawable.badge_background);
        this.requestLayout();
